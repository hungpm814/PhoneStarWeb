<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  <%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
      ...
      <c:if test="${requestScope.checkbuy!=null}">
                <script>
      ...
      <div class="welcome">
        <center>
          <img src="images/welcome.jpg" alt="Hot Series" class="welcome-image">
          <div class="welcome-content">
            <h2>SERIES NỔI BẬT</h2>
            <p>Samsung Galaxy S24 Series sẽ mang tới những đặc điểm nổi bật mới và một trải nghiệm hoàn hảo.</p>
            <a href="filter?brand=2" class="btn">Xem ngay</a>
          </div>
        </center>
      </div>
      ...
      <div class="container">
        ...
        <h2 class="list-header">Sản phẩm mới nhất</h2>

        <div class="phonelist row">
          <c:forEach items="${requestScope.listnew}" var="p">
        ...
        <h2 class="list-header">Các sản phẩm</h2>
